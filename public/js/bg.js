  ...
  function generateParticles(n) {
    let value = `${getRandom(2000)}px ${getRandom(2000)}px #09f`;
    for (let i = 2; i <= n; i++) {
      value += `, ${getRandom(2000)}px ${getRandom(2000)}px #09f`;
    }
    return value;
  }
  ...
  function initBG() {
    ...
    if (stars2) {
      ...
      animation: animateParticle 400s linear infinite;
      `;
    }
    ...
    if (stars3) {
      ...
      animation: animateParticle 500s linear infinite;
      `;
    }
  }
